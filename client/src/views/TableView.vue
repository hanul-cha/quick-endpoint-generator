      ...
      <div class="p-4 mb-6 bg-white border border-gray-200 rounded-lg">
        <div class="flex items-center justify-between mb-4">
          ...
          <button
            ...
            class="px-4 py-2 text-indigo-600 rounded-md hover:bg-indigo-50"
          >
            Edit
          </button>
        </div>
                ...
                <tr v-for="(row, index) in rowStore.items.items" :key="row.id">
                  ...
                  <td class="px-6 py-4 text-sm font-medium whitespace-nowrap">
                    <div class="flex space-x-2 text-sm">
                      <button
                        @click="editRow(row)"
                        class="px-4 py-1 text-indigo-600 rounded-md hover:bg-indigo-50"
                      >
                        Edit
                      </button>
                      <button
                        @click="deleteRowConfirm(row.id)"
                        class="px-4 py-1 text-red-600 rounded-md hover:bg-red-50"
                      >
                        Delete
                      </button>
                    </div>
